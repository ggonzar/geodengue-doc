...
% affiliations
\author{\IEEEauthorblockN{Maximiliano Báez González \IEEEauthorrefmark{1},
Guillermo González Rodas\IEEEauthorrefmark{2}}
\IEEEauthorblockA{Facultad Politécnica- Universidad Nacional de Asunción\\
    P.O.Box: 2111 SL, San Lorenzo - Central - Paraguay\\
Email: \IEEEauthorrefmark{1}maxibaezpy@gmail.com,
\IEEEauthorrefmark{2}ggonzalez@pol.una.py}}
