...
positiva entre la densidad del vector y la enfermedad humana\cite{dengueUruguayCap2}.
...
%~ * Índices de Stegomia
\input{capitulo-3/indices-stegomia.tex}
\input{capitulo-3/metodos-trampas.tex}
%~ * Distribución de dispositivos de ovipostura
%\input{capitulo-3/densidad-vectorial/larvitrampa.tex}
%~ * Seguimiento y control de dispositivos de ovipostura
%\input{capitulo-3/densidad-vectorial/ovitrampa.tex}
%~ * Recolección de resultados
%\input{capitulo-3/densidad-vectorial/mosquiterica.tex}
