...
\begin{minipage}{\textwidth}
    ...
    \end{tabular}
    \caption{\label{fig:sig-raster-resolucion} Curvas de nivel rasterizadas con tamaño de celda demasiado grande y con un tamaño adecuado (Tomado de \citet{fAlonsoSig2006}).}
\end{minipage}
\end{figure}
