...
\begin{minipage}{\textwidth}
    ...
    \end{tabular}
    \caption{\label{fig:sig-raster-resolucion} Curvas de nivel rasterizadas,(a) con tamaño de celda demasiado grande y (b) con un tamaño de celda adecuado (Tomado de \cite{fAlonsoSig2006}).}
\end{minipage}
\end{figure}
...
raster resultan más lentas con el modelo vectorial \cite{fAlonsoSig2006}. Tradicionalmente se ha
...
\begin{minipage}{\textwidth}
    ...
    \end{tabular}
    \caption{\label{fig:sig-raster-vs-vectorial} Representación de una misma superficie, mediante los formatos (a) ráster y (b) vectorial, en un SIG.}
\end{minipage}
\end{figure}
