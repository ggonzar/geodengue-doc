...
La resolución y la nitidez del la capa raster depende del tamaño de la celda
(\figref{fig:sig-raster-resolucion}), donde el tamaño esta asociado a la cantidad de columnas y
filas de la capa raster. Mientras más filas y columnas cuente una capa raster, más nítida será la
imagen resultante.
...
\begin{minipage}{\textwidth}
    \begin{tabular}{c c }
        \initbox
        \num\putindeepbox[7pt]{\includegraphics[width=0.4\textwidth]{capitulo-2/graphics/raster-baja-resolucion.png}} &
        \num\putindeepbox[7pt]{\includegraphics[width=0.4\textwidth]{capitulo-2/graphics/raster-alta-resolucion.png}} \\
    \end{tabular}
    \caption{\label{fig:sig-raster-resolucion} Curvas de nivel rasterizadas con tamaño de celda demasiado grande y con un tamaño adecuado (Tomado de \cite{fAlonsoSig2006}).}
\end{minipage}
\end{figure}
...
ráster resultaran mucho más lentas con el modelo vectorial \cite{fAlonsoSig2006}.
...
almacenamiento y tratamiento \cite{fAlonsoSig2006}. Los gráficos vectoriales, se caracterizan por
...
\begin{minipage}{\textwidth}
    \begin{tabular}{c c }
        \initbox
        \num\putindeepbox[7pt]{\includegraphics[width=0.4\textwidth]{capitulo-2/graphics/formato-raster.png}} &
        \num\putindeepbox[7pt]{\includegraphics[width=0.4\textwidth]{capitulo-2/graphics/formato-vectorial.png}} \\
    \end{tabular}
